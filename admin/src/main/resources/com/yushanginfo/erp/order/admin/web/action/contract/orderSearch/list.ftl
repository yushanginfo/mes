[#ftl]
  ...
  <div class="card card-info card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title">订单信息
        <span class="badge badge-primary">${salesOrders.totalItems}</span>
      </h3>
        ...
        <table class="table table-hover table-sm">
         ...
         <nav aria-label="Page navigation example">
           <ul class="pagination float-right">
             [#if salesOrders.pageIndex > 1]
             <li class="page-item"><a class="page-link" href="#" onclick="listOrder(1)">首页</a></li>
             <li class="page-item"><a class="page-link" href="#"  onclick="listOrder(${salesOrders.pageIndex-1})">${salesOrders.pageIndex-1}</a></li>
             [/#if]
             <li class="page-item active"><a class="page-link" href="#" >${salesOrders.pageIndex}</a></li>
             [#if salesOrders.pageIndex < salesOrders.totalPages]
             <li class="page-item"><a class="page-link" href="#" onclick="listOrder(${salesOrders.pageIndex+1})">${salesOrders.pageIndex+1}</a></li>
             <li class="page-item"><a class="page-link" href="#" onclick="listOrder(${salesOrders.totalPages})">末页</a></li>
             [/#if]
           </ul>
         </nav>
    </div>
