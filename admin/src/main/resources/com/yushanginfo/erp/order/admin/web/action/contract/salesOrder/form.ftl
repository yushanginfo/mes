...
[@b.toolbar title="修改订单信息"]bar.addBack();[/@]
  [@b.form action=b.rest.save(salesOrder) theme="list" name="salesOrderForm"]
    ...
    [@b.datepicker name="salesOrder.deadline" label="客户交期" value=(salesOrder.deadline)!  required="true"  format="yyyy-MM-dd" /]
    [@b.datepicker name="salesOrder.plannedEndOn" label="计划交期" value=(salesOrder.plannedEndOn)!  required="true"  format="yyyy-MM-dd" /]
