...
[@b.toolbar title="编辑到料日期"]bar.addBack();[/@]
  [@b.form action=b.rest.save(workOrder) theme="list"]
    ...
    [@b.datepicker id="readyOn" name="materialAssess.readyOn" label="到料日期" value=(materialAssess.readyOn)! minDate="${b.now?string('yyyy-MM-dd')}" format="yyyy-MM-dd" comment=dataRange/]
