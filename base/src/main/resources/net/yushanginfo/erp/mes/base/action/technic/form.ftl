...
[@b.toolbar title="工艺基本信息"]bar.addBack();[/@]
  [@b.form action=b.rest.save(technic) theme="list"]
    ...
    [@b.select name="technic.group.id" label="评审组" items=groups value=technic.group! required="true"/]
    [@b.textfield name="technic.duration" label="默认需要" value=technic.duration!  maxlength="3" comment="天"/]
